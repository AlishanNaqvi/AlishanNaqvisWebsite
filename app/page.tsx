      ...
      <main className="container py-10">
        ...
        <section className="py-12 md:py-24 lg:py-32 flex flex-col items-center text-center relative overflow-hidden hero-background">
          ...
          <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center relative z-20">
            ...
            <p className="text-xl text-gray-300">Software Engineer & App Developer</p>
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-4">
                  With experience in React Native, Go, and various other technologies, I've worked on projects ranging
                  from mobile applications to e-commerce websites. I'm particularly interested in building scalable
                  solutions and creating exceptional user experiences.
                </p>
                <p className="text-lg text-muted-foreground">
                  As a co-founder of ScorpioCustoms Ltd., I've also developed entrepreneurial skills in product design,
                  marketing, and business development, driving a 30% increase in revenue through strategic initiatives.
                </p>
              </div>
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span>Honours BSc in CS & Statistics (2027)</span>
                </div>
              </div>
            </div>
          </div>
