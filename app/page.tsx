            ...
            <div className="grid gap-8">
              ...
              <Card>
                ...
                <CardContent>
                  <ul className="list-disc pl-5 space-y-2">
                    <li>
                      Built scalable APIs using Go, integrating PostgreSQL, Firestore, and JWT, boosting system security and efficiency by 50%                    </li>
                    <li>
                      Enhanced real-time React Native features, improving app responsiveness and user experience by 35%
                    </li>
                    <li>
