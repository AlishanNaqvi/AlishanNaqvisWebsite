      ...
      <header className="sticky top-0 z-40 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between">
          ...
          <nav
            className={`${
              isMobile
                ? `fixed inset-0 z-50 bg-background p-6 ${isMobileMenuOpen ? "flex" : "hidden"} flex-col items-center justify-center space-y-6`
        ...
        <section className="py-12 md:py-24 lg:py-32 flex flex-col items-center text-center relative overflow-hidden hero-background">
          ...
          <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center relative z-20">
            <div className="relative w-48 h-48 rounded-full overflow-hidden mb-6 border-4 border-white shadow-lg">
              <Image src="/Headshot.png" alt="Alishan Naqvi" fill className="object-cover" priority />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <p className="text-lg text-muted-foreground mb-4">
                  I'm a passionate Software Engineer and App Developer based in Toronto, currently pursuing an Honours
                  Bachelor of Science double majoring in Computer Science and Statistics at the University of Toronto.
                </p>
                <p className="text-lg text-muted-foreground mb-4">
                  My goal is to design and build digital solutions that are not only efficient and user-friendly but
                  also engaging and aesthetically pleasing. I bring a unique perspective to every project by blending
                  technical expertise with creativity. Whether it's a dynamic web application or a thoughtful design, I
                  strive to deliver solutions that effectively convey your message and identity. I've collaborated with
                  diverse teams and contributed to projects that have made a meaningful impact.
                </p>
              </div>
              <div className="space-y-4">
                ...
                <div className="flex items-align justify-between">
                  ...
                  <span className="text-right">
                    Bachelor of Science - Double Major in Computer Science & Statistics (2027)
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {projects.map((project, index) => (
                <ProjectModal key={index} {...project} isMobile={isMobile} />
              ))}
            </div>
          </div>
        </section>
